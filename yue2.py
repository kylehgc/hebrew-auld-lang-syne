...
usage: YUE2_URL=https://<you>-yue2.hf.space HF_TOKEN=hf_... python yue2.py out/yue2_take.flac [--seed 831001] [--cot full|melody] [--abc file.abc] [--temp 1.0] [--cfg 0] [--style "..."]
...
cot = opt("--cot", "melody")
temperature = float(opt("--temp", 1.0))
cfg = float(opt("--cfg", 0))
